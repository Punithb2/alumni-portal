...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # ── 8. CLUBS ──────────────────────────────────────────────────────────
        clubs_data = [
            {'name': 'CS Alumni Network', 'description': 'A community for Computer Science alumni to network, share opportunities, and stay connected.', 'category': 'professional', 'is_private': False, 'status': 'active', 'icon': '💻', 'tags': ['networking', 'tech', 'cs'], 'cover_image': 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80', 'creator': 'alex@alumni.com'},
            {'name': 'Startup Founders Hub', 'description': 'For alumni who have founded or are building startups. Share experiences, find co-founders, and get advice.', 'category': 'professional', 'is_private': False, 'status': 'active', 'icon': '🚀', 'tags': ['startups', 'entrepreneurship', 'founders'], 'cover_image': 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=800&q=80', 'creator': 'michael@alumni.com'},
            {'name': 'Women in Tech', 'description': 'A supportive community for women in technology from our alumni network.', 'category': 'social', 'is_private': False, 'status': 'active', 'icon': '👩‍💻', 'tags': ['women', 'diversity', 'tech'], 'cover_image': 'https://images.unsplash.com/photo-1573164713988-8665fc963095?w=800&q=80', 'creator': 'emily@alumni.com'},
            {'name': 'Sports & Fitness Club', 'description': 'Stay active with fellow alumni! Organize sports events, marathons, and fitness challenges.', 'category': 'sports', 'is_private': False, 'status': 'active', 'icon': '🏃', 'tags': ['sports', 'fitness', 'health'], 'cover_image': 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80', 'creator': 'raj@alumni.com'},
        ]
