              ...
              <Popup className="rounded-xl overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <img
                      src={profile.avatar || `https://ui-avatars.com/api/?name=${profile.first_name}+${profile.last_name}&background=f3f4f6&color=2563eb`}
                      alt={profile.first_name}
                      className="w-10 h-10 rounded-full border border-gray-200"
                    />
                    <div>
                      <h4 className="font-bold text-gray-900 text-sm">{profile.first_name} {profile.last_name}</h4>
                  ...
                  <button 
                    className="w-full mt-3 bg-blue-50 text-blue-600 font-medium py-1.5 rounded-lg text-xs hover:bg-blue-100 transition-colors"
                  >
                    View Profile
                  </button>
                </div>
