...
const DropdownFilter = ({ label, value, options, onChange }) => {
    ...
    const hasSelection = value !== 'All' && value !== 'All Levels' && value !== 'All Types' && value !== 'All Industries' && value !== 'All Locations';
    return (
...
const JobsFilterBar = ({
    ...
    alumniRecommendedOnly, setAlumniRecommendedOnly
}) => {
    return (
            ...
            <div className="flex items-center justify-between flex-wrap gap-4 max-w-[1500px] mx-auto">
                ...
                <div className="flex items-center flex-wrap gap-2">
                    {setAlumniRecommendedOnly && (
                        ...
                        >
                            <CheckSquare className={`w-4 h-4 ${alumniRecommendedOnly ? 'text-amber-600' : 'text-slate-400'}`} />
                            Alumni Recommended
                        </button>
                    )}
                    <DropdownFilter
                    ...
                    <DropdownFilter
                        ...
                        options={['All Industries', 'Technology', 'Finance', 'Healthcare', 'Education', 'Non-profit']}
                    />
                    <DropdownFilter
                        label="Location"
