                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in slide-in-from-right-4">
                            ...
                            <div className="space-y-3">
                                <label className="block text-sm font-semibold text-slate-700">Attendee Details</label>
                            ...
                            {!isFree && (
                                <div className="space-y-3">
                                    <label className="block text-sm font-semibold text-slate-700">Select Ticket</label>
                                    <div className="grid grid-cols-2 gap-3">
                                        {['General', 'VIP'].map((type) => (
                                            <label
                                                key={type}
                                                className={`flex flex-col p-4 rounded-xl border cursor-pointer transition-colors ${ticketType === type
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center justify-between mb-2">
                                                    ...
                                                    {ticketType === type && <CheckCircle2 size={16} className="text-indigo-600" />}
                                                </div>
                ...
                {step !== 3 && (
                    <div className="p-5 border-t border-slate-100 bg-slate-50 flex gap-3">
                        ...
                        <button
                            ...
                            className={`flex-1 py-2.5 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 shadow-sm transition-all flex items-center justify-center gap-2 ${isProcessing ? 'opacity-75 cursor-wait' : ''
                                }`}
                        >
                            {isProcessing ? (
