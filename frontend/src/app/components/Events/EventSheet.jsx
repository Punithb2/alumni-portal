            ...
            <div className="px-6 md:px-8 space-y-6">
              ...
              <div className="prose prose-slate max-w-none prose-p:leading-relaxed text-slate-600 text-sm md:text-base">
                ...
                <p>
                  ...
                  lifelong relationships among our vibrant alumni community. This event features expert
                  panels, dedicated networking sessions, and opportunities to meaningfully engage with
                  your peers.
                </p>
              </div>
            </div>
        ...
        <div className="sticky bottom-0 bg-white border-t border-slate-200 p-4 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] w-full flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:mb-0 mb-2 w-full sm:w-auto">
            ...
            <div className="flex gap-4 text-sm text-slate-500 font-medium">
              <span className="flex items-center gap-1.5"><Ticket size={14} />{event.attendees || 0} Registered</span>
              {event.capacity && (
                 <span className="flex items-center gap-1.5"><Users size={14} />{Math.max(0, event.capacity - (event.attendees || 0))} Left</span>
              )}
            </div>
          </div>
