                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <div
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      formData.isPaid ? 'bg-indigo-600' : 'bg-slate-300'
                    }`}
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="mt-0.5">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, requireApproval: !formData.requireApproval })
                      }
                    />
                    <div
                      className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.requireApproval ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-white border-slate-300 group-hover:border-indigo-400'}`}
                    >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Manually approve attendees before they receive tickets.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="mt-0.5">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, sendReminders: !formData.sendReminders })
                      }
                    />
                    <div
                      className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.sendReminders ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-white border-slate-300 group-hover:border-indigo-400'}`}
                    >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Send reminders 1 week, 1 day, and 1 hour before the event.
                    </p>
                  </div>
                </label>
              </div>
