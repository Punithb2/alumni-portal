...
const SUGGESTED = [
  {
    ...
    members: 420,
    avatar:
      'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=150&h=150',
    type: 'Interest Group',
  },
  {
    id: 102,
    ...
    members: 855,
    avatar:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=150&h=150',
    type: 'Interest Group',
  },
  {
    id: 103,
    name: 'Startup Founders 2025',
    members: 120,
    avatar:
      'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&q=80&w=150&h=150',
    type: 'Interest Group',
  },
]
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-indigo-50 rounded-xl p-3 text-center">
                ...
                <p className="text-lg font-black text-slate-900">
                  {groupDetails.membersCount?.toLocaleString()}
                </p>
            ...
            <div className="text-xs text-slate-500 font-medium space-y-1 pt-1">
              <p>
                📅 Created:{' '}
                <span className="text-slate-700 font-bold">{groupDetails.createdAt}</span>
              </p>
              <p>
                🏷️ Type: <span className="text-slate-700 font-bold">{groupDetails.type}</span>
              </p>
              <p>
                🔖 Category:{' '}
                <span className="text-slate-700 font-bold">{groupDetails.category}</span>
              </p>
            </div>
      ...
      <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-800 rounded-2xl shadow-md border border-indigo-700 overflow-hidden text-white">
        <div className="p-5">
          ...
          <p className="text-indigo-200 text-xs font-medium mb-5">
            Join chapters, cohorts, and groups to grow your network.
          </p>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              {
                label: 'Total Members',
                value: stats?.members ? `${(stats.members / 1000) | 0}k+` : '12k+',
              },
            ].map((s) => (
              <div
                key={s.label}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="p-4 grid grid-cols-2 gap-2">
          {[
            ...
            <button
              key={cat.label}
              className={`flex items-center gap-2 p-2.5 rounded-xl text-xs font-bold transition-all hover:scale-105 ${cat.color}`}
            >
              <span>{cat.icon}</span>
              {cat.label}
            </button>
