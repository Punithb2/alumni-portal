...
const INITIAL_CAMPAIGNS = [
  {
    ...
    story:
      'Help us support the next generation of outstanding students. This fund will provide full tuition scholarships to 10 deserving students from underrepresented backgrounds.',
  ...
  },
  {
    ...
    story:
      'Cyclone Maha has displaced 200+ students from hostels in the eastern campus. We need urgent funds for temporary shelter, food, and essential supplies.',
  ...
  },
  {
    ...
    story:
      'Upgrade the university library with a state-of-the-art tech wing featuring AR/VR labs, high-speed collaborative workspaces, and 24/7 digital resource access.',
  ...
  },
  {
    ...
    story:
      'Join us for the 5th Annual Alumni Marathon. Run for health, run for unity! A strictly free participation event.',
  ...
  },
  {
    ...
    story:
      "Fund cutting-edge AI and machine learning research that will power India's next generation of tech innovation, led by faculty and doctoral students.",
  ...
  },
  {
    ...
    story:
      'Renovate and modernize the campus sports facilities to foster physical well-being and inter-collegiate sports achievement.',
  ...
  },
  {
    ...
    story:
      'Join us for our annual campus-wide blood donation drive. Your single donation can save up to 3 lives in our local community.',
  ...
  },
  {
    ...
    story:
      'Run for a cause! Join fellow alumni in our 5K and 10K runs to promote fitness and raise awareness for mental health on campus.',
...
const INITIAL_MY_DONATIONS = [
  {
    id: 'd1',
    campaignId: 'c1',
    campaignTitle: 'Alumni Scholarship Fund 2026',
    amount: 2000,
    date: '2026-02-14',
    status: 'completed',
    anonymous: false,
  ...
  },
  {
    id: 'd2',
    campaignId: 'c3',
    campaignTitle: 'New Library Tech Wing',
    amount: 5000,
    date: '2026-01-10',
    status: 'completed',
    anonymous: false,
  ...
  },
  {
    id: 'd3',
    campaignId: 'c5',
    campaignTitle: 'Campus Sports Complex Renovation',
    amount: 1000,
    date: '2025-08-20',
    status: 'completed',
    anonymous: false,
