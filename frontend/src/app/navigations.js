...
export const NAV_SECTIONS = [
  {
    heading: null,
    items: [
      { name: 'My feed', path: '/dashboard', icon: 'LayoutDashboard', auth: ['Alumni', 'Student', 'SA'] },
      ...
      { name: 'Campaigns', path: '/campaigns', icon: 'HeartHandshake', auth: ['Alumni', 'Student', 'SA'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Manage Events', path: '/admin/events', icon: 'CalendarDays', auth: ['University', 'SA'] },
      { name: 'Manage Campaigns', path: '/admin/campaigns', icon: 'Megaphone', auth: ['University', 'SA'] },
