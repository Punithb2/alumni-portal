...
import { Calendar, MapPin, Mail, Droplet, X, MoreHorizontal, BadgeCheck, UserPlus, UserCheck, MessageSquare, Heart, MessageCircle, Share2, Bookmark } from 'lucide-react'
            ...
            <div className="px-5 sm:px-6 pb-6 relative bg-white">
               <div className="relative -mt-12 sm:-mt-16 mb-4 flex justify-between items-end">
                  <div className="p-1 bg-white rounded-full inline-block shadow-md relative z-10">
                    ...
                    {profile.status === 'online' && (
                       <div className="absolute bottom-1 right-1 w-4 h-4 sm:w-5 sm:h-5 bg-emerald-500 border-[3px] border-white rounded-full" title="Online"></div>
                    )}
                  </div>
               ...
               <div className="grid grid-cols-1 gap-y-3 gap-x-2 text-[13px] sm:text-[14px] text-slate-600 mb-6 bg-slate-50 p-4 rounded-xl border border-slate-100/60">
                  ...
                  <div className="flex items-center gap-3">
                     ...
                     <span className="truncate">{profile.email || `${profile.name.split(' ')[0].toLowerCase()}@gmail.com`}</span>
                  </div>
                  <div className="flex items-center gap-3">
               ...
               <div className="mt-6 mb-8 min-h-[250px]">
                    ...
                    <div className="flex flex-col gap-4">
                       ...
                       <div className="bg-white border border-slate-100 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center justify-between mb-4 text-left">
                            <div className="flex items-center gap-3">
                               <img src={profile.avatar} alt="" className="w-10 h-10 rounded-full border border-slate-100" />
                               <div>
                                  <p className="text-[14px] sm:text-[15px] font-bold text-slate-900 leading-none">{profile.name}</p>
                 ...
                 {activeTab === 'About' && (
                    <div className="text-[14px] sm:text-[15px] text-slate-600 bg-slate-50/80 p-5 rounded-xl border border-slate-100/60 shadow-sm">
                       ...
                       <p className="leading-relaxed">{profile.about || 'No additional details provided. User prefers to keep their bio short and sweet.'}</p>
                    ...
                    <div className="text-[14px] sm:text-[15px] text-slate-600 bg-slate-50/80 p-5 rounded-xl border border-slate-100/60 shadow-sm">
                       ...
                       <div className="flex gap-4">
                          ...
                          <div className="pt-0.5">
                             <p className="font-bold text-slate-900 leading-tight">University of Example</p>
                             <p className="text-slate-600 mt-1 font-medium">{profile.major || 'Computer Science'}</p>
                             <p className="text-slate-500 text-[12px] sm:text-[13px] mt-1 bg-white px-2 py-0.5 inline-block rounded-md border border-slate-100">Class of {profile.graduationYear || '2020'}</p>
                          </div>
                       </div>
                    </div>
                 )}
                    ...
                    <div className="text-[14px] sm:text-[15px] text-slate-600 bg-slate-50/80 p-5 rounded-xl border border-slate-100/60 shadow-sm relative overflow-hidden">
                       ...
                       <div className="flex gap-5 relative z-10 mb-8">
                          ...
                          <div className="-mt-0.5">
                             <p className="font-bold text-slate-900 text-[15px] sm:text-[16px]">{profile.role || 'Research Scientist'}</p>
                             <p className="text-slate-600 mt-0.5 text-[14px] sm:text-[15px]">{profile.company || 'DeepMind'}</p>
